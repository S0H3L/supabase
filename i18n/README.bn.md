...
[Supabase](https://supabase.com) ফায়ারবেসের একটি ওপেন সোর্স বিকল্প। আমরা এন্টারপ্রাইজ-গ্রেড ওপেন সোর্স টুল ব্যবহার করে Firebase-এর বিকপ্ল তৈরি করছি।
...
সম্পূর্ণ ডকুমেন্টেশনের জন্য, [supabase.com/docs](https://supabase.com/docs) পেইজটি দেখুন

কিভাবে অবদান রাখতে হয় তা দেখতে, [Getting Started](./DEVELOPERS.md) পেইজটি দেখুন
